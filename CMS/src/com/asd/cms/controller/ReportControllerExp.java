...
@Controller
@RequestMapping("/main")
public class ReportControllerExp {
	...
	public void viewReport(HttpServletRequest request, HttpServletResponse response) {
		...
		String path = request.getSession().getServletContext().getRealPath("/resources/jasper/UserWiseExpenseReport.jrxml");
